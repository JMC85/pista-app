...
// Nota: es una foto del momento actual, no un histórico (eso requeriría guardar datos
// todos los días durante meses, que no tenemos).
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // 3. Por cada canal, guardar su video de mejor desempeño en esta búsqueda
    ...
    // 4. Traer datos de suscriptores de esos canales (hasta 50 por llamada)
    ...
    // 5. Calcular ratio vistas/suscriptor y armar el resultado, priorizando canales chicos
